...
<body>
    <section class="Congratulations Akaaaaaaaaaash">
        <h1>Congratulations!</h1>
        <p>Your AWS Elastic Beanstalk <em>PHP</em> application is now running on your own dedicated two one environment in the AWS&nbsp;Cloud</p>
